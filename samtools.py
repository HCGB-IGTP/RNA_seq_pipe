...
def SamToBam(path_results, path_sam, threads, gtf):
...
def BamToSortedBam(path_results, path_bam, threads, gtf):
    ...
    featurecounts (path_results, sorted_bam_name, threads, gtf)
