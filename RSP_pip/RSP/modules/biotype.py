...
def run_biotype(options):
    ...
    First, it executes the maping calling map RSP module.
    ...
    :param options: input parameters introduced by the user. See RSP biotype -h.
    ...
    aesthetics_functions.pipeline_header('RSP')
    ...
    if (options.skip_report):
        ...
        ## create plot: call R and RSP::stats 
