...
def multiQC_module_call(givenList, name, path, option):
    ...
    .. seealso:: This function depends on other rnaseqpipe functions called:
    
        - :func:`rnaseqpipe.scripts.functions.printList2file`
        
        - :func:`rnaseqpipe.scripts.multiQC_report.multiQC_call`
...
def multiQC_call(pathFile, name, folder, option):
    ...
    :returns: :func:`rnaseqpipe.scripts.functions.system_call_functions.system_call` output (OK/FALSE)
        
    .. seealso:: This function depends on other rnaseqpipe functions called:
    
        - :func:`rnaseqpipe.scripts.functions.system_call_functions.system_call`
