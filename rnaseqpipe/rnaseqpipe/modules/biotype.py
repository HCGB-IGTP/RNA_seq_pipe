...
from rnaseqpipe.modules import help_RSP, map
from rnaseqpipe.scripts import RNAbiotype, multiQC_report
#from rnaseqpipe.other_tools import tools
...
def run_biotype(options):
    ...
    First, it executes the maping calling map rnaseqpipe module.
    ...
    :param options: input parameters introduced by the user. See rnaseqpipe biotype -h.
    ...
    if (options.help_format):
        ## help_format option
        help_rnaseqpipe.help_fastq_format()
    elif (options.help_project):
        ## information for project
        help_rnaseqpipe.project_help()
        exit()
    ...
    aesthetics_functions.pipeline_header('rnaseqpipe')
    ...
    if (options.skip_report):
        ...
        ## create plot: call R and rnaseqpipe::stats 
